...
<header>
	...
	<a href="inactive_user.jsp" class="btn">inactive_user</a>
	
				  <a href="biggest_buy.jsp" class="btn">BIGGEST_Buy</a>
				<a href="biggest_buyer.jsp" class="btn">BIGGEST_Buyer</a>
					<a href="neverbuy_user.jsp" class="btn">never_buy_user</a>
					<a href="neversell_user.jsp" class="btn">never_sell_user</a>
